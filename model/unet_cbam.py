...
class UNet_cbam(nn.Module):
    def __init__(self):
        ...
        self.down_conv_2 = down_double_conv(64, 128)
        self.down_conv_3 = down_double_conv(128, 256)
        self.down_conv_4 = down_double_conv(256, 512)
        self.down_conv_5 = down_double_conv(512, 1024)
...
def down_double_conv(in_c, out_c):
    conv = nn.Sequential(
